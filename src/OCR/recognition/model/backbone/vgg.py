...
class Vgg(nn.Module):
    def __init__(self, name, ss, ks, hidden, weights='VGG19_BN_Weights.IMAGENET1K_V1', dropout=0.5):
...
def vgg11_bn(ss, ks, hidden, weights='VGG11_BN_Weights.IMAGENET1K_V1', dropout=0.5):
    return Vgg('vgg11_bn', ss, ks, hidden, weights, dropout)

def vgg19_bn(ss, ks, hidden, weights='VGG19_BN_Weights.IMAGENET1K_V1', dropout=0.5):
    return Vgg('vgg19_bn', ss, ks, hidden, weights, dropout)
